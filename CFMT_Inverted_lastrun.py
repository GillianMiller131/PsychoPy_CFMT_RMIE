...
expName = 'CFMT_Inverted'  # from the Builder filename that created this script
expInfo = {
    'participant': 'P0',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/gillian/Documents/GitHub/PsychoPy_CFMT_RMIE/CFMT_Inverted_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='This activity will be the same as the first activity.\n\nYou will see a face from three different directions, then you will be asked to identify that face from a line up.\n\nThis time though, the faces will be upside-down.\n\n[]',
    font='Open Sans',
...
Practice_Choices = visual.ImageStim(
    ...
    ori=180.0, pos=(0, 0), size=(0.8, 0.4),
    color=[1,1,1], colorSpace='rgb', opacity=None,
...
text_8 = visual.TextStim(win=win, name='text_8',
    text='Great Work! \n\nHow did you feel about the difficulty between the upside-down and right-side up version?\n\nWas one harder or were they the same?\n\n1.Upright 2.Inverted 3.Same',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
for thisPart1_Learn in Part1_Learn:
    ...
    while continueRoutine and routineTimer.getTime() < 9.0:
        ...
        # *mem_3* updates
        if mem_3.status == NOT_STARTED and tThisFlip >= 6.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mem_3.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mem_3.tStartRefresh + 3.0-frameTolerance:
                # keep track of stop time/frame for later
